    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Unique identifier of the product")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Url of the image of the product"),
                    SellerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date and time the product was added on"),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Shows if the product is deleted or not")
                },
                constraints: table =>
                {
